...
var A = {
  Util: {
    util_method1: function util_method1() {},
    util_method2: function util_method2() {} //...

  },
  Tool: {
    tool_method1: function tool_method1() {},
    tool_method2: function tool_method2() {} //...
...
var LazySingle = function LazySingle() {
  //单例实例引用
...
var Vue; // 这个Vue的作用和楼上的instance作用一样
...
function install(_Vue) {
  ...
  Vue = _Vue; // 将Vuex的初始化逻辑写进Vue的钩子函数里
...
Vue.use(Vuex); //...(中间添加/修改了一些store的数据)
// 在后续的逻辑里不小心又安装了一次

Vue.use(Vuex); //失去了单例判断能力的 install 方法，会为当前的Vue实例重新注入一个新的 Store，也就是说你中间的那些数据操作全都没了，一切归 0。因此，单例模式在此处是非常必要的。